...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './taskFunctions.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\n\n\nconst inputTask = document.querySelector('#input-task');\nconst taskListPlaceholder = document.querySelector('.task-list-placeholder');\nconst clearBtn = document.querySelector('#clear-btn');\n\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './taskFunctions.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './taskFunctions.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();\n\n// Execute a function when the user presses a key on the keyboard\ninputTask.addEventListener('keypress', (event) => {\n  // If the user presses the \"Enter\" key on the keyboard\n  if (event.key === 'Enter') {\n    const toDoListData = JSON.parse(window.localStorage.getItem('taskData') || '[]');\n    // Cancel the default action, if needed\n    event.preventDefault();\n    const index = toDoListData.length + 1;\n    const toDoClass = new Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './taskFunctions.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(inputTask.value.trim(), false, index);\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './taskFunctions.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(toDoClass);\n    taskListPlaceholder.innerHTML = '';\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './taskFunctions.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();\n    inputTask.value = '';\n  }\n});\n\nclearBtn.addEventListener('click', () => {\n  const toDoListData = JSON.parse(window.localStorage.getItem('taskData') || '[]');\n  const clearItems = toDoListData.filter((completeList) => completeList.completed === false);\n  window.localStorage.setItem('bookData', JSON.stringify(clearItems));\n  Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './taskFunctions.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(clearItems);\n  taskListPlaceholder.innerHTML = '';\n  Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './taskFunctions.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();\n});\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
