...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_displayFunctions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/displayFunctions.js */ \"./src/modules/displayFunctions.js\");\n/* harmony import */ var _modules_classOperation_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/classOperation.js */ \"./src/modules/classOperation.js\");\n/* harmony import */ var _modules_helperFunctions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/helperFunctions.js */ \"./src/modules/helperFunctions.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\n\n\nconst inputTask = document.querySelector('#input-task');\nconst clearBtn = document.querySelector('#clear-btn');\n// populate list when the page opens\n(0,_modules_displayFunctions_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n(0,_modules_helperFunctions_js__WEBPACK_IMPORTED_MODULE_2__.updateCompletedDisplay)();\n\n// Execute a function when the user presses a key on the keyboard\ninputTask.addEventListener('keypress', (event) => {\n  // If the user presses the \"Enter\" key on the keyboard\n  if (event.key === 'Enter') {\n    const toDoListData = JSON.parse(window.localStorage.getItem('taskData') || '[]');\n    // Cancel the default action, if needed\n    event.preventDefault();\n    const index = toDoListData.length;\n    const toDoClass = new _modules_classOperation_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](inputTask.value.trim(), false, index);\n    toDoClass.addTask(toDoClass);\n    inputTask.value = '';\n  }\n});\n\nclearBtn.addEventListener('click', () => {\n  const toDoListData = JSON.parse(window.localStorage.getItem('taskData') || '[]');\n  const clearItems = toDoListData.filter((completeList) => completeList.completed === false);\n  window.localStorage.setItem('bookData', JSON.stringify(clearItems));\n  resetIndex(clearItems);\n  (0,_modules_displayFunctions_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n});\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
